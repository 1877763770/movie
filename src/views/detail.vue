        ...
        data () {
            return {
                movie: {
                    ...
                    comments: [
                        {user:"谋杀游戏机",content:"完全不是超英片，就是一个以普通底层小市民为主角的犯罪片，大概也是这些年漫威DC所有电影里人性剖析最深刻的一部。影片对哥谭市有着出色的氛围营造，阴暗潮湿的道路，满目垃圾的街头",star:"4",date:"2019-08-31",zan:"6083"},
                        {user:"保卫胡萝卜",content:"再也不要有人跳出来把DC和漫威比了，这已经是金狮体系了。",star:"4",date:"2019-09-10",zan:"2288"}
                    ],
                    scoring:{
                        score:"8.8",
                        five:60,
